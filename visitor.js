    ...
    t.exports = function (e) {
      ...
      e.ACL = function (t) {
        ...
        if (r.permissionsById = {}, n.isObject(t))
          if (t instanceof e.User) r.setReadAccess(t, !0), r.setWriteAccess(t, !0);
          else {
        ...
        if (r instanceof e.User ? r = r.id : r instanceof e.Role && (r = "role:" + r.getName()), !n.isString(r)) throw "userId must be a string.";
    ...
    (function (n) {
      ...
      t.exports = function (t) {
        ...
        t.File = function (r, s, u) {
          ...
          if (this._guessedType = h, i.isArray(s)) this._source = t.Promise.as(a(s), h), this._metaData.size = s.length;
          else if (s && s.base64) {
            var f = e("./browserify-wrapper/parse-base64"),
              d = f(s.base64, h);
            this._source = t.Promise.as(d, h)
          } else if (s && s.blob) this._source = t.Promise.as(s.blob, h);
          else if ("undefined" != typeof File && s instanceof File) this._source = t.Promise.as(s, h);
          else if (t._isNode && n.Buffer.isBuffer(s)) this._source = t.Promise.as(s.toString("base64"), h), this._metaData.size = s.length;
      ...
      e.Object = function (t, r) {
        ...
        change: function (t) {
          ...
          for (var a = function (e, t) {
            ...
            }; !n.isEmpty(this._pending);) this._pending = {}, this.trigger("change", this, t), e._objectEach(this.changed, a), i._previousAttributes = n.clone(this.attributes);
    ...
    t.exports = function (e) {
      e.User = e.Object.extend("_User", {
        ...
        signUp: function (t, r) {
          ...
          if (!s || "" === s) return i = new e.Error(e.Error.OTHER_CAUSE, "Cannot sign up user with an empty name."), r && r.error && r.error(this, i), e.Promise.error(i);
          var a = t && t.password || this.get("password");
          if (!a || "" === a) return i = new e.Error(e.Error.OTHER_CAUSE, "Cannot sign up user with an empty password."), r && r.error && r.error(this, i), e.Promise.error(i);
          var o = n.clone(r);
        ...
        signUpOrlogInWithMobilePhone: function (t, r) {
          ...
          if (!s || "" === s) return i = new e.Error(e.Error.OTHER_CAUSE, "Cannot sign up or login user by mobilePhoneNumber with an empty mobilePhoneNumber."), r && r.error && r.error(this, i), e.Promise.error(i);
          var a = t && t.smsCode || this.get("smsCode");
          if (!a || "" === a) return i = new e.Error(e.Error.OTHER_CAUSE, "Cannot sign up or login user by mobilePhoneNumber  with an empty smsCode."), r && r.error && r.error(this, i), e.Promise.error(i);
          var o = n.clone(r);
  ...
  28: [function (e, t, n) {
    (function () {
      ...
      y.each = y.forEach = function (e, t, n) {
        ...
        for (var t, n = E(e) ? e : y.values(e), r = n.length, i = Array(r), s = 0; r > s; s++) t = y.random(0, s), t !== s && (i[s] = i[t]), i[t] = n[s];
        return i
      ...
      var U = function (e, t, n, r) {
        ...
        if (n.push(e), r.push(t), s) {
          ...
          for (; u--;)
            if (c = l[u], !y.has(t, c) || !U(e[c], t[c], n, r)) return !1
        }
